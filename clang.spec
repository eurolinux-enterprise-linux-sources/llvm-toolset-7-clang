...
Patch5:		0001-Allow-operator-delete-to-be-an-invalid-Decl.patch
...
# just want clang.
%package -n %{?scl:%scl_prefix}git-clang-format
Summary: clang-format integration for git
Requires: %{name}%{?_isa} = %{version}-%{release}
Requires: git
Requires: python2

%description -n %{?scl:%scl_prefix}git-clang-format
...
%patch4 -p1 -b .retpoline
%patch5 -p1 -b .operator-fix
...
%files -n %{?scl:%scl_prefix}git-clang-format
